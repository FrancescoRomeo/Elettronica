...
<div class="footer-top-area">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<div class="copyright">
						<p>
							&copy; 2017 pwmElectronics. All Rights Reserved.
						</p>
					</div>
				</div>
	...
	<!-- jQuery sticky menu -->
	<script src=<%=root + "/WebApp/js/owl.carousel.min.js"%>></script>
	<script src=<%=root + "/WebApp/js/jquery.sticky.js"%>></script>

	<!-- jQuery easing -->
	<script src=<%=root + "/WebApp/js/jquery.easing.1.3.min.js"%>></script>

	<!-- Main Script -->
	<script src=<%=root + "/WebApp/js/main.js"%>></script>
</body>
</html>
